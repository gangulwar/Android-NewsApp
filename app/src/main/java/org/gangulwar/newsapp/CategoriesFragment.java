...
public class CategoriesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewPager viewPager = view.findViewById(R.id.categoriesViewPager);

        ArrayList<TopStroiesModal> dataForTab1 = createDataForTab1(); // Implement this method
        ArrayList<TopStroiesModal> dataForTab2 = createDataForTab1(); // Implement this method

        PagerAdapter pagerAdapter = new ViewPagerAdapter(getChildFragmentManager(), dataForTab1, dataForTab2,context);
...
//        topStories.setAdapter(topStroiesAdapter);
    ...
    private ArrayList<TopStroiesModal> createDataForTab1() {

        ArrayList<TopStroiesModal> temp = new ArrayList<>();

        temp.add(new TopStroiesModal(
                "NPR",
                "Author 1",
                "Soldiers declare Niger general as head of state following coup - NPR",
                "Mutinous soldiers who staged a coup in Niger declared their leader, Gen. Abdourahmane Tchiani, the new head of state on Friday. A spokesman also said that the constitution was suspended.",
